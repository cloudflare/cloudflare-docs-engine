    ...
    <a className="DocsMobileTitleHeader--logo-link Link Link-without-underline" href="./"> {/* TODO - href */}
      <div className="DocsNavLogoLockup">
        <div className="DocsNavLogoLockup--logo">
          ...
          {/* TODO - supply from project settings so it’s not Workers-specific */}
          <svg id="WorkersDashboardMobileLogomark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" role="img" aria-labelledby="WorkersDashboardMobileLogomark--title WorkersDashboardMobileLogomark--desc" fill="currentColor">
            <defs>
              <title id="WorkersDashboardMobileLogomark--title">Cloudflare Workers dashboard logomark</title>
              <desc id="WorkersDashboardMobileLogomark--desc">The logomark used to represent Cloudflare Workers inside the Cloudflare dashboard.</desc>
            </defs>
