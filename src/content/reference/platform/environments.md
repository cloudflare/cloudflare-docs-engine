...
__Note__: You can only interact with environments using [wrangler](/reference/wrangler-cli).
...
Once a text variable is uploaded via [wrangler](/reference/wrangler-cli/) or in the UI, the string is exposed on the global namespace as type [`String`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String).
